...
The following is a minimal configuration for [`semantic-release`](https://github.com/nholuongut/semantic-release) with a build running on the latest LTS version of Node when a new commit is pushed to a `master/main` branch.
