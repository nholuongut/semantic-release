...
[Open a Pull Request](https://github.com/nholuongut/semantic-release/blob/master/CONTRIBUTING.md#submitting-a-pull-request) to add your plugin to the list.
...
- [semantic-release-commits-lint](https://github.com/BondarenkoAlex/semantic-release-commits-lint)
  - `analyzeCommits` Analyzing commit messages by [commitlint](https://github.com/nholuongut/commitlint).
